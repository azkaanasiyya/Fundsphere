            ...
            <div className="container mx-auto px-5 py-6 lg:px-8 lg:py-8">
                <div className="navbar-wrapper flex justify-between items-center">
                    <div className="navbar-block flex justify-between items-center gap-[7.5rem]">
                        ...
                        <ul className={`flex gap-[52px] text-base font-medium text-neutral-500 fixed lg:static 2lg:bg-transparent 2lg:w-auto 2lg:h-full 2lg:translate-y-0 2lg:flex-row 2lg:shadow-none 2lg:p-0 2lg:m-0 2lg:transition-none ${menuActive} top-60 -translate-y-1/2 w-full flex-col px-8 py-6 rounded shadow-lg shadow-slate-300 bg-primary-300 transition-all`}>
                            <li>
